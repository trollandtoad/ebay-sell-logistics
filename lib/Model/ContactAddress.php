...
class ContactAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets country_code
     *
     * @param string|null $country_code The country of the address, represented as two-letter ISO 3166-1 Alpha-2 country code. For example, US represents the United States and DE represents Germany. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/CountryCodeEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
