...
class Dimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets unit
     *
     * @param string|null $unit The unit of measure used to express the height, length, and width of the package. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/LengthUnitOfMeasureEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
