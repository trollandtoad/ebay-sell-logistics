...
class PurchasedRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $max_estimated_delivery_date A string value representing maximum (latest) estimated delivery time, formatted as an ISO 8601 UTC string.
     *
     * @return self
     */
     ...
     *
     * @param string|null $min_estimated_delivery_date A string value representing minimum (earliest) estimated delivery time, formatted as an ISO 8601 UTC string.
     *
     * @return self
     */
     ...
     * Sets pickup_type
     *
     * @param string|null $pickup_type The type of pickup or drop off configured for the shipment. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/PickupTypeEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
