...
class Rate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $max_estimated_delivery_date The latest stated date and time the shipment will be delivered at this rate. The time stamp is formatted as an ISO 8601 string, which is based on the 24-hour Universal Coordinated Time (UTC) clock. Format: YYYY-MM-DDTHH:MM:SS.SSSZ Example: 2018-08-04T07:09:00.000Z
     *
     * @return self
     */
     ...
     *
     * @param string|null $min_estimated_delivery_date The estimated earliest date and time the shipment will be delivered at this rate. The time stamp is formatted as an ISO 8601 UTC string. Format: YYYY-MM-DDTHH:MM:SS.SSSZ Example: 2018-08-06T01:00:00.000Z
     *
     * @return self
     */
     ...
     * Sets pickup_type
     *
     * @param string|null $pickup_type The type of pickup or drop-off service associated with the pickupSlots time frames. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/PickupTypeEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
