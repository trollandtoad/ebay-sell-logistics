...
class Shipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets creation_date
     *
     * @param string|null $creation_date The date and time the shipment was created, formatted as an ISO 8601 UTC string. Format: YYYY-MM-DDTHH:MM:SS.SSSZ Example: 2018-08-06T01:00:00.000Z
     *
     * @return self
     */
