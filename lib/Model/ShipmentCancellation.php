...
class ShipmentCancellation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $cancellation_status This enum specifies the current cancellation status of a shipment, if a cancellation request has been made. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/ShipmentCancellationStatusEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
