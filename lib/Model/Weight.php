...
class Weight implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets unit
     *
     * @param string|null $unit The unit of measure used to express the weight of the package. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/WeightUnitOfMeasureEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
